...
// WP receive URL for toggles (new endpoint you’ll add below)
const WP_TOGGLE_URL     = Deno.env.get("WP_TOGGLE_URL")!; // e.g. https://hassan.skillyweb.com/wp-json/secure-collections/v1/toggle
...
function requireBearer(req: Request) {
  ...
  if (t !== SERVICE_ROLE_KEY) return json(401, { ok:false, error:"unauthorized" });
  return null;
}
